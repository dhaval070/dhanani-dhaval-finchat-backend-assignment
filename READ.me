...
Containts endpoints to create new customer, create a payment and retreive all payments by customer
...
fiber for API server
stripe-go for Stripe
joho/godotenv to read secret key and listen address from .env file. 
